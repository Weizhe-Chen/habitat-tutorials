...
from habitat.config.default_structured_configs import HeadRGBSensorConfig
...
def example():
    ...
    with habitat.config.read_write(config):
        top_rgb_cfg = HeadRGBSensorConfig(
        width=256,
        height=256,
        ...
        config.habitat.simulator.agents.main_agent.sim_sensors.top_rgb_sensor = top_rgb_cfg
